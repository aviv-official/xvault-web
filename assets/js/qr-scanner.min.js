export class QrScanner {
    static async hasCamera() {
        try {
            ...
            return a.some((a_1) => "videoinput" === a_1.kind);
        }
        catch (e) {
            return !1;
        }
    }
    constructor(a, c, b = QrScanner.DEFAULT_CANVAS_SIZE) {
        this.$video = a;
    ...
    static scanImage(a, c = null, b = null, d = null, f = !1, g = !1) {
        let h = !1,
            l = new Promise((l, g) => {
                b || (b = new Worker(QrScanner.WORKER_PATH), h = !0, b.postMessage({
                    type: "inversionMode",
                    data: "both"
                }));
                let n, m, k;
                ...
                QrScanner._loadImage(a).then((a) => {
                    a = QrScanner._getImageData(a, c, d, f);
                    b.postMessage({
                        type: "decode",
                        data: a
                    }, [a.data.buffer])
        ...
        c && g && (l = l.catch(() => QrScanner.scanImage(a, null, b, d, f)));
        return l = l.finally(() => {
            h && b.postMessage({
                type: "close"
            })
    ...
    _scanFrame() {
        ...
        requestAnimationFrame(() => {
            QrScanner.scanImage(this.$video, this._sourceRect, this._qrWorker, this.$canvas, !0).then(this._onDecode, (a) => {
    ...
    static _loadImage(a) {
        ...
        if (a instanceof Image) return QrScanner._awaitImageLoad(a).then(() => a);
        if (a instanceof File || a instanceof URL || "string" === typeof a) {
            let c = new Image;
            c.src = a instanceof File ? URL.createObjectURL(a) : a;
            return QrScanner._awaitImageLoad(c).then(() => {
